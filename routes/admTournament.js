...
dataTournament.delete('/delete/:urlID',authentication.committeAuth,admTournamentController.deleteTournament)
...
dataTournament.put('/match1/:urlID',authentication.committeAuth,admTournamentController.match1)
dataTournament.put('/match2/:urlID',authentication.committeAuth,admTournamentController.match2)
dataTournament.put('/match3/:urlID',authentication.committeAuth,admTournamentController.match3)
dataTournament.put('/match4/:urlID',authentication.committeAuth,admTournamentController.match4)
dataTournament.put('/bronzeMatch/:urlID',authentication.committeAuth,admTournamentController.bronzeMatch)
...
dataTournament.put('/ffa/match1/:tournamentID',authentication.committeAuth,admTournamentController.match1Ffa)
dataTournament.put('/ffa/match2/:tournamentID',authentication.committeAuth,admTournamentController.match2Ffa)
dataTournament.put('/ffa/match3/:tournamentID',authentication.committeAuth,admTournamentController.match3Ffa)
